...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default=ROOT / 'D:\\develop\\anoconda\\envs\\yolov5\\runs\\train\exp4\\weights\\best.pt',
                        help='model path(s)')
...
if __name__ == "__main__":
    # im = cv2.imread(r'D:\develop\anoconda\envs\yolov5\crack_detection\images\00001.jpg')
    # BGR 3通道图像
