...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    save_best_path = opt.save_best_path
    ...
    if os.path.exists(save_best_path):
        shutil.rmtree(save_best_path)
    shutil.copytree(str(opt.save_dir), save_best_path)
    return results
...
def parse_opt(known=False):
    ...
    parser.add_argument('--save_best_path', type=str, default='', help='W&B: Version of dataset artifact to use')
...
from split_train_val import stv
# # 模拟训练函数，以这种格式获取参数即可
def test_train(parameter, save_path, old_model_path, dataset_path):
    """
    :param parameter: 参数json：epochs=、batch-size=、workers=
...
if __name__ == "__main__":
    ...
    # save_path = r'D:\develop\anoconda\envs\fault_detection-master\fault_detection-master\yolo\yolov5_6\yolov5_6\outputs'
    ...
    # dataset_path = r'D:\develop\anoconda\envs\yolov5\crack_detection'
    # stv(dataset_path)
