...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../resource/导出icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../resource/删除icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../resource/感叹号icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: 10px;  border: 2px groove gray;")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../resource/相机icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../resource/文件icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
