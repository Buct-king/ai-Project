...
"}")
        ...
        self.annotationPushButton.setGeometry(QtCore.QRect(830, 40, 81, 41))
        ...
        self.deleteModelPushButton.setGeometry(QtCore.QRect(20, 350, 81, 41))
        ...
        self.deleteDatasetPushButton = QtWidgets.QPushButton(self.tab_2)
        self.deleteDatasetPushButton.setGeometry(QtCore.QRect(430, 340, 81, 41))
        self.deleteDatasetPushButton.setStyleSheet("border-radius: 10px;  border: 2px groove gray;")
        self.deleteDatasetPushButton.setIcon(icon1)
        self.deleteDatasetPushButton.setObjectName("deleteDatasetPushButton")
...
"")
        ...
        self.datasetListLabel = QtWidgets.QLabel(self.tab_2)
        self.datasetListLabel.setGeometry(QtCore.QRect(420, 20, 81, 31))
        self.datasetListLabel.setStyleSheet("font: 25 11pt \"Adobe 宋体 Std L\";\n"
"")
        self.datasetListLabel.setObjectName("datasetListLabel")
        self.trainingPushButton = QtWidgets.QPushButton(self.tab_2)
        self.trainingPushButton.setGeometry(QtCore.QRect(830, 350, 81, 41))
        ...
        self.datasetTableView.setGeometry(QtCore.QRect(410, 50, 281, 261))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteDatasetPushButton.setText(_translate("MainWindow", "删除数据集"))
        self.modelsListLabel.setText(_translate("MainWindow", "模型列表"))
        self.datasetListLabel.setText(_translate("MainWindow", "数据集列表"))
