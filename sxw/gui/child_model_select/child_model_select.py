...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.modelListLabel.setGeometry(QtCore.QRect(30, 20, 61, 20))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.modelListLabel.setFont(font)
        self.modelListLabel.setObjectName("modelListLabel")
        self.okModelSelectPushButton = QtWidgets.QPushButton(self.centralwidget)
        self.okModelSelectPushButton.setGeometry(QtCore.QRect(200, 510, 93, 36))
        ...
        self.modelTableView.setGeometry(QtCore.QRect(30, 40, 441, 451))
        self.modelTableView.setStyleSheet("border-color: rgb(179, 179, 179);\n"
