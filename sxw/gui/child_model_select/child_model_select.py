...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.okModelSelectPushButton.setGeometry(QtCore.QRect(180, 220, 75, 23))
        ...
        self.modelTableView.setGeometry(QtCore.QRect(30, 40, 256, 151))
        self.modelTableView.setObjectName("modelTableView")
        self.presentModelLabel = QtWidgets.QLabel(self.centralwidget)
        self.presentModelLabel.setGeometry(QtCore.QRect(310, 20, 181, 20))
        self.presentModelLabel.setObjectName("presentModelLabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.presentModelLabel.setText(_translate("MainWindow", "当前模型"))
